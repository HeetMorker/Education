...
//       // Send the POST request to add the course (Existing API: /api/courses/create)
//       const response = await axios.post('http://localhost:5000/api/courses/create', courseData, config);
...
//               <li className="breadcrumb-item" aria-current="page">Add Course</li>
//             </ul>
...
const AddCourse = () => {
  ...
  const { courseId } = useParams(); // Get the courseId from the URL if in edit mode
