          ...
          <div className="navbar-content h-[calc(100vh_-_74px)] py-2.5">
            <div className="card pc-user-card mx-[15px] mb-[15px] bg-theme-sidebaruserbg dark:bg-themedark-sidebaruserbg">
              <div className="card-body !p-5">
                <div className="flex items-center"><img className="shrink-0 w-[45px] h-[45px] rounded-full" src="../assets/images/user/avatar-1.jpg" alt="user-image" />
                  <div className="ml-4 mr-2 grow">
                    <h6 className="mb-0">Jonh Smith</h6><small>Administrator</small>
                  </div><a className="shrink-0 btn btn-icon inline-flex btn-link-secondary" data-pc-toggle="collapse" href="#pc_sidebar_userlink"><svg className="pc-icon w-[22px] h-[22px]">
                    <use xlinkHref="#custom-sort-outline" />
                  </svg></a>
                </div>
                <div className="hidden pc-user-links" id="pc_sidebar_userlink">
                  <div className="pt-3 *:flex *:items-center *:py-2 *:gap-2.5 hover:*:text-primary-500"><a href="#!"><i className="text-lg leading-none ti ti-user" /> <span>My Account</span>
                  </a><a href="#!"><i className="text-lg leading-none ti ti-settings" />
                      <span>Settings</span> </a><a href="#!"><i className="text-lg leading-none ti ti-lock" /> <span>Lock Screen</span> </a><a href="#!"><i className="text-lg leading-none ti ti-power" /> <span>Logout</span></a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <ul className="pc-navbar">
              ...
              <li className="pc-item pc-hasmenu"><a href="/" className="pc-link"><span className="pc-mtext">Home</span></a></li>
              <li className="pc-item"><a href="/add-courses" className="pc-link"><span className="pc-mtext">Add Courses</span></a></li>
              <li className="pc-item"><a href="/addexpense" className="pc-link"><span className="pc-mtext">My Enrollements</span></a></li>
              <li className="pc-item"><a href="/grade-students/:courseID" className="pc-link"><span className="pc-mtext">Grade Students</span></a></li>
            </ul>
          </div>
        </div>
      </nav>
      <header className="pc-header">
        <div className="header-wrapper flex max-sm:px-[15px] px-[25px] grow">
          ...
          <div className="ms-auto">
            <ul className="inline-flex *:min-h-header-height *:inline-flex *:items-center">
              <li>
                <div className="grid ">  <button className="btn btn-primary flex items-center justify-center" onClick={handleLogout}>
